...
class FileStorage:
    ...
    Attributes:
        ...
        __objects (dict): collection instantiated objects.
    """
    ...
    def new(self, obj):
        """assign in __objects obj with key <obj_class_name>.id"""
    ...
    def reload(self):
        """Deserialisation of the JSON file __file_path to __objects, if it exists."""
        try:
