...
class TestBase(unittest.TestCase):
    ...
    def test_to_dict_type_created_at(self):
        '''
            Checking the type of the value of created_at.
        '''
    ...
    def test_type_created_at(self):
        '''
            Testing that the new_model's updated_at
    ...
    def test_type_updated_at(self):
        '''
            Testing that the new_model's created_at
            data type is datetime.
        '''
        my_model_dict = self.my_model.to_dict()
        new_model = BaseModel(my_model_dict)
    ...
    def test_compare_dict(self):
        '''
            Testing that the new_model's and my_model's
    ...
    def test_instance_diff(self):
        '''
            Testing that the my_model and new_model are
